...
class NProgressContainer extends React.Component<{
  ...
  componentDidMount() {
    ...
    Router.events.on('routeChangeComplete', this.routerChangeEnd);
    Router.events.on('routeChangeError', this.routerChangeEnd);
  }

  componentWillUnmount() {
    clearTimeout(this.timer);
    Router.events.off('routeChangeStart', this.routerChangeStart);
    Router.events.off('routeChangeComplete', this.routerChangeEnd);
    Router.events.off('routeChangeError', this.routerChangeEnd);
  }
